...
namespace Defra.Trade.ReMoS.AssuranceService.UI.Hosting.Pages.Registration.Assurances
{
    public class UpdatedTermsAndConditions : BasePageModel<UpdatedTermsAndConditions>
    {
        ...
        public async Task<IActionResult> OnPostSubmitAsync()
        {
            ...
            if (!TandCs)
            {
                ModelState.AddModelError(nameof(TandCs), $"Confirm that the authorised representative has read and understood the updated terms and conditions, or click ‘Skip for now’");
            }
