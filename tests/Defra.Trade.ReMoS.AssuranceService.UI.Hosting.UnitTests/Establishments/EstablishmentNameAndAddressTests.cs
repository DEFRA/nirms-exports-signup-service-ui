...
namespace Defra.Trade.ReMoS.AssuranceService.UI.Hosting.UnitTests.Establishments
{
    ...
    public class EstablishmentNameAndAddressTests : PageModelTestsBase
    {
        ...
        public void OnPostSubmit_SubmitValidAddress_DuplicateSpotted()
        {
            ...
            _mockEstablishmentService.Setup(x => x.GetEstablishmentsForTradePartyAsync(new Guid(), false, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>()).Result).Returns(list);
